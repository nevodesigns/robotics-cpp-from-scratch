...
```text
24 lessons   9 phases   51 atlas entries   4 toolchains claimed   38 hours of material
```
<!-- COUNTS:END -->
...
| 04 Build Systems and Tooling | 1 | A build system, so CMake stops being an incantation |
