...
```text
25 lessons   9 phases   52 atlas entries   4 toolchains claimed   40 hours of material
```
<!-- COUNTS:END -->
...
| 03 C++ Core III | 2 | A config parser that explains every way a line can be wrong |
| 04 Build Systems and Tooling | 2 | A crash triage tool, built on real captured backtraces |
| 05 Testing and Fakes | 1 | The test framework you have been using, rebuilt by you |
