// rc/core/text.hpp
//
// The text helpers from lesson 01-05, graduated.
//
// std::string owns its characters and std::string_view does not, which is the
// whole distinction: a view is a pointer and a length, exactly like rc::span,
// and it dangles the moment the thing it views goes away.
