...
```text
84 lessons   16 phases   200 atlas entries   4 toolchains claimed   175 hours of material
```
<!-- COUNTS:END -->
...
| 11 Qt Quick and QML | 1 | A QML interface whose failures are visible from a test rather than from a console nobody is watching |
