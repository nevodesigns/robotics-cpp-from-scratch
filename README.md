...
```text
34 lessons   10 phases   68 atlas entries   4 toolchains claimed   57 hours of material
```
<!-- COUNTS:END -->
...
| 06 Robot Maths | 3 | Orientation stored the way every later phase will store it |
