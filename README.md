...
```text
54 lessons   13 phases   113 atlas entries   4 toolchains claimed   98 hours of material
```
<!-- COUNTS:END -->
...
| 13 Kinematics and Dynamics | 2 | An arm whose tool position you can compute, and check against a closed form |
