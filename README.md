...
```text
44 lessons   12 phases   95 atlas entries   4 toolchains claimed   77 hours of material
```
<!-- COUNTS:END -->
...
|---|---|---|
| 00 Toolchain and First Motion | 5 | A simulated robot driving a quarter circle |
