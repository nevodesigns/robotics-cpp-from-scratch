...
```text
64 lessons   15 phases   140 atlas entries   4 toolchains claimed   125 hours of material
```
<!-- COUNTS:END -->
...
| 16 Estimation and Navigation | 4 | An honest account of where the robot thinks it is, and how wrong that is by now |
<!-- PHASES:END -->
