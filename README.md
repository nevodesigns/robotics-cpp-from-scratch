...
```text
78 lessons   15 phases   182 atlas entries   4 toolchains claimed   161 hours of material
```
<!-- COUNTS:END -->
...
| 03 C++ Core III | 5 | An injectable clock, so dt finally has a provenance |
| 04 Build Systems and Tooling | 3 | A library of your own, installed, and consumed by a project that has never seen its source |
| 05 Testing and Fakes | 4 | A test suite you can prove catches bugs, because you watched it catch six |
...
| 09 Qt Core | 3 | A sensor on its own thread, reaching the interface without ever touching it |
| 10 Qt Widgets | 4 | A live chart of any signal, in a window and in a terminal, that does not lie about a steady one |
| 13 Kinematics and Dynamics | 4 | An arm asked its question in both directions, exactly where a formula exists and numerically where one does not |
