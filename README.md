...
```text
32 lessons   10 phases   65 atlas entries   4 toolchains claimed   53 hours of material
```
<!-- COUNTS:END -->
...
| 06 Robot Maths | 1 | Cross track error, the number a path follower steers on |
