// rc/core/batch.hpp
//
// The reading batch helpers from lesson 03-04, graduated.
//
// Written with the standard algorithms rather than by hand, which is shorter
// and, more usefully, says what is being done rather than how. The traps that
// lesson catalogued are all in here: accumulate with an integer seed, remove_if
// without the erase, and a comparator that is not a strict ordering.

#ifndef RC_CORE_BATCH_HPP
