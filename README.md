...
```text
53 lessons   13 phases   111 atlas entries   4 toolchains claimed   95 hours of material
```
<!-- COUNTS:END -->
...
| 13 Kinematics and Dynamics | 1 | An arm whose tool position you can compute, and check against a closed form |
