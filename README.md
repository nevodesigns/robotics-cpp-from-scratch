...
```text
45 lessons   12 phases   96 atlas entries   4 toolchains claimed   79 hours of material
```
<!-- COUNTS:END -->
...
|---|---|---|
| 00 Toolchain and First Motion | 6 | A simulated robot driving a quarter circle |
