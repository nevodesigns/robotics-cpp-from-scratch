...
```text
74 lessons   15 phases   170 atlas entries   4 toolchains claimed   151 hours of material
```
<!-- COUNTS:END -->
...
| 13 Kinematics and Dynamics | 3 | An arm asked its question in both directions, exactly where a formula exists and numerically where one does not |
| 14 Control | 4 | A loop you can tune, with four measured numbers rather than a feeling |
| 15 Sensors, Drivers and Vision | 5 | A noisy sensor made usable, with the cost of making it so measured rather than guessed, and a camera frame read the way it was actually laid out |
