...
```text
46 lessons   12 phases   99 atlas entries   4 toolchains claimed   80 hours of material
```
<!-- COUNTS:END -->
...
|---|---|---|
| 00 Toolchain and First Motion | 7 | Your robot's quarter circle, drawn, with nothing installed but a compiler |
