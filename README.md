...
```text
68 lessons   15 phases   152 atlas entries   4 toolchains claimed   136 hours of material
```
<!-- COUNTS:END -->
...
| 05 Testing and Fakes | 3 | A test suite you can prove catches bugs, because you watched it catch six |
| 06 Robot Maths | 4 | Where the gripper is, in the world frame, and how you know |
| 07 Concurrency and Real Time | 4 | A measured latency histogram of your own control loop |
...
| 10 Qt Widgets | 3 | A live chart of any signal, in a window and in a terminal, that does not lie about a steady one |
...
| 15 Sensors and Drivers | 4 | A noisy sensor made usable, with the cost of making it so measured rather than guessed |
